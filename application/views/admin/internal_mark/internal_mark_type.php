                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/internal_mark/index" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label
                                        for="exampleInputEmail1"><?php echo $this->lang->line('subject'); ?></label><small class="req">*</small>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change', '#mark_type', function(e) {
            ...
            var type = $('#type').val();
            $('#sub_type').html("");
            if (value == "examination" && type == "practical") {

                var div = `
        <option value=''>Select</option>
        <option value="os">OS</option>
        <option value="dop">DOP</option>`;
            } else if (value == "continuous_assessment" && type == "practical") {
                var div = `
        <option value=''>Select</option>
        ...
        <option value='pc'>PC</option>`;
            } else if (value == "examination" && type == "theory") {
                var div = `
        <option value=''>Select</option>
        <option value='unit_test'>Unit Test</option>
        <option value='sessional'>Sessional</option>
        `;
            } else if (value == "continuous_assessment" && type == "theory") {
                var div = `
        <option value=''>Select</option>
        <option value='assignment'>Assignment</option>
