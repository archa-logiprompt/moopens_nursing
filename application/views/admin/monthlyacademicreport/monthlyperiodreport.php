                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <table style="width:100%;" border="1">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                <th style="text-align:center">T(<?php echo abs($total / 60 - $total_cm / 60) ? abs($total / 60 - $total_cm / 60) : 0 ?>)</th>
                                                <th style="text-align:center">P(<?php echo $student['practical_pm'][0]['total'] ? $student['practical_pm'][0]['total'] : 0 ?>)</th>
                                                <th style="text-align:center">T(<?php echo $total_cm / 60 ? $total_cm / 60 : 0 ?>)</th>
                                                ...
                                                $theory_max = $total / 60 + $total_cm / 60 ?>
                                                <th style="text-align:center">T(<?php echo $total / 60 ?>)</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center"><?php echo $student['theory_pm'][$key]['minutes'] ? abs($student['theory_pm'][$key]['minutes'] / 60 - $row['minutes'] / 60) : 0 ?></td>
                                                    <td style="text-align:center"><?php echo $student['practical_pm'][$key]['present_count'] ? $student['practical_pm'][$key]['present_count'] : 0 ?></td>
                                                    <td style="text-align:center"><?php echo $row['minutes'] ? $row['minutes'] / 60 : 0  ?></td>
                                                    ...
                                                    <td style="text-align:center"><?php echo $student['theory_pm'][$key]['minutes'] / 60 ?></td>
                                                    <td style="text-align:center"><?php echo $practical_total ?></td>
                                                    
                                                    <?php $percentage = (($student['theory_pm'][$key]['minutes'] / 60) + $practical_total) / ($total/60 + $practical_max); ?>
