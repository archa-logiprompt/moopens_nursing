    ...
    $(document).on('click', '.schedule_modal', function () {
        ...
        $.ajax({
            ...
            success: function (response) { 
                ...
                data += "<th class='text text-center'><?php echo 'Signature' ?></th>";
                ...
                $.each(response, function (i, obj)
                {
                   ...
                   data += '<td class="">' + obj.name + '</td>';
                    ...
                    data += '<td class="text text-center"> </td>';
...
//===========
    ...
    customize: function (win) {
        const headerImageUrl = '<?php echo base_url("./uploads/header.png"); ?>'; // Path to your image
    ...
    const imageElement = {
        ...
        // Add Class and Section at the top
        win.content.unshift({
    text: [
        { text: 'Course: ', bold: true, fontSize: 12 },
        { text: classname + " (" + sectionname + ")\n", fontSize: 12 },
        { text: 'Exam: ', bold: true, fontSize: 12 },
        { text: examname + "\n\n", fontSize: 12 }
    ],
    margin: [0, 0, 0, 12], // Margin for spacing
    alignment: 'left' // Align to the left
        ...
        win.content.push({
            text: [
                { text: '\n\n\n', fontSize: 12 }, // Adds space at the bottom
