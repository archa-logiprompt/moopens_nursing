                                ...
                                <form role="form" id="" class="addschedule-form" method="post" action="<?php echo site_url('admin/examschedule/create') ?>">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <input id="date_<?php echo $value['id'] ?> " name="date_<?php echo $value['id'] ?>" placeholder="Enter Date" type="text" class="form-control datepicker"  value="<?php echo $exam_date; ?>" readonly="readonly"/>
                                                    ...
                                                    <td>
                                                    <div class="form-group">
                                                    <?php /* <select id="teacher_<?php echo $value['id'] ?>" name="teacher_<?php echo $value['id'] ?>" class="form-control">
                                                  ...
                                                  <?php   }  $count++; ?>
                                                    ...
                                                    */?>
                                                    <?php $checkedTeachers = explode(',',$value['scheduleteacher']);?>
                                                    <select multiple="multiple" name="teacher_<?php echo $value['id'] ?>[]" id="subject_id"
                                    class="subject-selector form-control">
                                    <option value=''>
                                        <?php echo $this->lang->line("select") ?>
                                    </option>
                                    <?php
                                    foreach ($teacherlist as $key => $value1) {
                                        ?>
                                        <option value1='<?php echo $value1['id'] ?>' <?php echo (in_array($value1['id'], $checkedTeachers)) ? "selected" : "";
?>>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <div class="form-group">
                                                            ...
                                                            <!--<input type="text" name="remarks_<?php echo $value['id'] ?>" class="form-control" id="remarks_<?php echo $value['id'] ?>" value="<?php echo $value['remarks'] ?>" placeholder="Enter Remarks">-->
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
...
<script>
    ...
    */});
    ...
    $(document).ready(function () {
        // $('.subject-selector').multiselect(); 

        $('.subject-selector').selectpicker('render');

        getSectionByClass($('#class_id').val())


        // $('#btnAdd').hide();
        var btncount = <?php echo !empty($combined_subjects)?count($combined_subjects):0?>;

        $('#btnAdd').on('click', function () {

            $parentRow = $(this).parent().parent()
            $($parentRow).append(`<div class="col-md-11" style="margin-bottom:2%">
             <select multiple="multiple" name="teacher[${btncount+1}][]" id="subject_id"  class="subject-selector form-control">
                <option value=''>
                    <?php echo $this->lang->line("select") ?>
                </option>
                <?php
