                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <form role="form" id="updatecalendar_form" method="post"
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_one"><?php echo "$period_list->period_one_from - $period_list->period_one_to" ?></label>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_two"><?php echo "$period_list->period_two_from - $period_list->period_two_to" ?></label>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_three"><?php echo "$period_list->period_three_from - $period_list->period_three_to" ?></label>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_four"><?php echo "$period_list->period_four_from - $period_list->period_four_to" ?></label>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_five"><?php echo "$period_list->period_five_from - $period_list->period_five_to" ?></label>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_six"><?php echo "$period_list->period_six_from - $period_list->period_six_to" ?></label>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_seven"><?php echo "$period_list->period_seven_from - $period_list->period_seven_to" ?></label>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1" id="period_eight"><?php echo "$period_list->period_eight_from - $period_list->period_eight_to" ?></label>
