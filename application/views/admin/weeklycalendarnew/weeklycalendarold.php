<style type="text/css">
   ...
   .planning-table {
        display: none; /* Hides the table on screen */
    }

    @media print {
        .planning-table {
            display: none !important; /* Ensures the table is hidden when printing */
        }
    }
    .print,
    .print * {
...
<?php if ($userdata['id'] == 305 || $userdata['id']==311
) { ?>
                                                    ...
                                                    <thead>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 15px;text-align:center"><?php echo "" ?></td>
                                                                <td style="padding: 15px;text-align:center"><?php echo "" ?></td>
                                                                <td style="padding: 15px;text-align:center"><?php echo ""?></td>
