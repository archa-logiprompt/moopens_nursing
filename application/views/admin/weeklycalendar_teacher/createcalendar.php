                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select autofocus="" id="period_id" name="class_id"
                                                                ...
                                                                <option value="eight_to_nine_div" id="period_one">08:00 AM - 09:00 AM
                                                                </option>
                                                                <option value="nine_to_ten_div" id="period_two">09:00 AM - 10:00 AM
                                                                </option>
                                                                <option value="ten_to_eleven_div" id="period_three">10:00 AM - 11:00 AM
                                                                </option>
                                                                <option value="eleven_to_twelve_div" id="period_four">11:00 AM - 12:00 PM
                                                                </option>
                                                                <option value="twelve_to_one_div" id="period_five">12:00 PM - 01:00 PM
                                                                </option>
                                                                <option value="two_to_three_div" id="period_six">02:00 PM - 03:00 PM
                                                                </option>
                                                                <option value="three_to_four_div" id="period_seven">03:00 PM - 04:00 PM
                                                                </option>
                                                                <option value="four_to_five_div" id="period_eight">04:00 PM - 05:00 PM
                                                                </option>
                                            ...
                                            <div class="teacher-div eight_to_nine_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" name="topic_teached" placeholder="Topic Teached"
                                                        class="form-control" id="topic_id">
                                                    <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <button class="btn btn-success attendance-button "> Attendance
                                                        <button class="btn btn-danger instruction" style="margin-left: 14px;"> Specific Instruction
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row" style='padding: 22px;'>
                                            <form onsubmit="false" id="attendance-form">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <button type="button" class="btn btn-primary save-attendance pull-right"
                        ...
                        <div id="InstructionModal" class="modal fade " role="dialog">
                            <div class="modal-dialog modal-dialog2 modal-lg" style="width:80%">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row" style='padding: 22px;'>
                                            <form id='specific-instruction-form'>

                                                <input type="hidden" name='hidden_class_internal' value="<?php echo $class_id ?>">
                                                <input type="hidden" name='hidden_section_internal' value="<?php echo $section_id ?>">
                                                <input type="hidden" name='hidden_period_internal' id='hidden_period_internal' value="">
                                                <input type="hidden" name='hidden_teacher_internal' id='hidden_teacher_internal' value="">
                                                <input type="hidden" name='hidden_subject_internal' id='hidden_subject_internal' value="">
                                                <input type="hidden" name='hidden_calendar_internal' id='hidden_calendar_internal' value="">
                                                <div class="form-group col-md-3">

                                                    <label for="exampleInputEmail1">Type</label>
                                                    <select id="internal_type_id" name="internal_type"
                                                        class="form-control">
                                                        <option value="">Select</option>

                                                        <?php foreach ($internalitems as $key => $value) {
                                                        ?>
                                                            <option marktype=<?php echo $value['isfixed'] ?> mark=<?php echo $value['mark'] ?> value="<?php echo $value['assignid'] ?>"><?php echo $value['itemname'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                ...
                                                <div class="form-group col-md-3 internal-mark-div" style="display: none;">
                                                    ...
                                                    <input
                                                        ...
                                                        class="form-control"
                                                        id="internal_mark_id">
                                                    <span class="text-danger"><?php echo form_error('internal_mark'); ?></span>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <textarea
                                                        ...
                                                        class="form-control"
                                                        id="internal_topic_id"></textarea>
                                                    <span class="text-danger"><?php echo form_error('internal_topic'); ?></span>
                                                </div>

                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <label for="exampleInputEmail1">Last Date</label>
                                                        <input autocomplete='false' value="<?php echo date($this->customlib->getSchoolDateFormat()) ?>" name="lastdate" type="text" class="form-control date" id='lastdate' />

                                                    </div>
                                                </div>

                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <button class="btn btn-primary save-internal pull-right" is-update='false'> Save
...
<script type="text/javascript">
    ...
    $(document).on('ready', function() {
        var selectElement = document.getElementById("period_id");
        var optionValues = [];
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#work_assigned_id', function(e) {
            ...
            let timestamp = new Date().getTime(); // Generate a timestamp
        ...
        `
            ...
            // You can use 'newFilename' for saving the file with the timestamp.
        });
    ...
    $(document).ready(function() {
        ...
        function view_event(id) {
            ...
            $.ajax({
                ...
                success: function(msg) {
                    $('#period_one').html(msg.period_one_from + "-" + msg.period_one_to);
                    $('#period_two').html(msg.period_two_from + "-" + msg.period_two_to);
                    $('#period_three').html(msg.period_three_from + "-" + msg.period_three_to);
                    $('#period_four').html(msg.period_four_from + "-" + msg.period_four_to);
                    $('#period_five').html(msg.period_five_from + "-" + msg.period_five_to);
                    $('#period_six').html(msg.period_six_from + "-" + msg.period_six_to);
                    $('#period_seven').html(msg.period_seven_from + "-" + msg.period_seven_to);
                    $('#period_eight').html(msg.period_eight_from + "-" + msg.period_eight_to);
                    getPeriods(msg)
                    setTimeout(() => {
        ...
        function getAttendanceData(options) {
            ...
            options.each(function() {
                ...
                if (optionvalue != '') {
                    var trimmedValue = $(this).val().replace("_div", "");
                    var promise = new Promise(function(resolve, reject) {

                        $.ajax({
                            type: 'POST',
                            url: base_url + "admin/weeklycalendarteacher/getcolorofcalender",
                            data: {
                                class_id: class_id,
                                section_id: section_id,
                                period: trimmedValue,
                            ...
                            success: function(data) {
                                if (data != 'null') {
                                    let attendance = JSON.parse(data);
                                    let period_name = attendance.period + '_div';
                                    var optionWithValue = $('.period_dropdown option[value=' + period_name + ']');
                                    // Assuming lightgreen is a color variable or a string containing the color
                                    $(optionWithValue).css('background-color', 'lightgreen'); // Set background color of the current period dropdown
                                }
                            }
                        });
                    });
        ...
        function getPeriods(periods) {
            ...
            filteredKeys = Object.keys(periods).filter(key => {
                ...
                if (key.endsWith("teacher") && periods[key]) {

                    let teachersarr = periods[key].split(',')
                    return (teachersarr.includes(user))
                }
    ...
    $(document).on("ready", () => {
        ...
        var internalType, mark, isfixed, $button, $parent, teacher, subject, calendarid, period;
        ...
        $(".instruction").on("click", function() {
            ...
            teacher = $parent.find('#teacher_id').val();

            subject = $parent.find('#subject_id').val();

            calendarid = $('#update_id_hidden').val()

            period = ($('#period_id').val()).replace(/_div/g, "")

            $('#hidden_period_internal').val(period)
            $('#hidden_teacher_internal').val(teacher)
            $('#hidden_subject_internal').val(subject)
            $('#hidden_calendar_internal').val(calendarid)


            $.ajax({
                type: 'POST',
                url: base_url + 'admin/weeklycalendarteacher/getSpecificInstruction',
                data: {
                    'period': period,
                    'teacher_id': teacher,
                    'subject_id': subject,
                ...
                success: (data) => {
                    if (data) {
                        ...
                        $('#internal_type_id').val(data.assigned_item_id).trigger("change")
                        $('#internal_mark_id').val(data.mark)
                        $('#internal_topic_id').val(data.topic)
                        $('#lastdate').val(data.lastdate)
                        $('.save-internal').attr('is-update', 'true')
                        $('.save-internal').text('Update')
        ...
        $("#internal_type_id").on("change", function(e) {

            if ($(this).val()) {

                internalType = $("#internal_type_id option:selected");
                mark = internalType.attr("mark");
                isfixed = internalType.attr("marktype");

                $("#internal_mark_id").attr("readonly", isfixed == 1);
                $("#internal_mark_id").val(mark);

                $(".internal-mark-div").show();

            } else {

                $(".internal-mark-div").hide();

            }

        });

        $(".save-internal").on("click", (e) => {

            e.preventDefault()

            var internaltopic = $('#internal_topic_id').val()
            var lastdate = $('#lastdate').val()

            if (!internaltopic || !internalType.val() || !lastdate) {
                alert('Fill All Fields')
                return;
            }

            let formdata = $('#specific-instruction-form').serialize();


            let is_update = $('.save-internal').attr('is-update')
            let endpoint = is_update == 'true' ? 'updateSpecificInstruction' : 'saveSpecificInstruction'

            $.ajax({
                type: "POST",
                url: base_url + "admin/weeklycalendarteacher/" + endpoint,
                data: formdata,
                dataType: "json",
                success: function(data) {
