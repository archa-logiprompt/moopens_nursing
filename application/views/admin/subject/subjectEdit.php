                        ...
                        <form action="<?php echo site_url("admin/subject/edit/" . $id) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <!-- <label class="radio-inline">
                                    <input type="radio" value="Theory" name="type"  <?php //if (set_value('type', $subject['type']) == "Theory") echo "checked"; 
                                                                                    ?> checked><?php //echo $this->lang->line('theory'); 
                                                                                                ?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="type" <?php //if (set_value('type', $subject['type']) == "Practical") echo "checked"; 
                                ...
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('subject') . " Color"; ?></label>
                                    <input id="color" name="color" placeholder="" type="color" class="form-control" value="<?php echo $subject['color']; ?>" />
                                    <span class="text-danger"><?php echo form_error('code'); ?></span>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-name" style="background-color: <?php echo $subject['color'] ?>;"><?php echo $subject['color'] ?></td>
