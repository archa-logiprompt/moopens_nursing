                    ...
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url('admin/subject/create') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('subject') . " Color"; ?></label><small class="req"> *</small>
                                    <input autofocus="" id="color" name="color" placeholder="" type="color" class="form-control" value="<?php echo set_value('name'); ?>" />
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>
