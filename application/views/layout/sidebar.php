...
<aside class="main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            ...
            if ($this->module_lib->hasActive('internal_marks')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('internal_marks'); ?>">
                        <a href="#">
                            <i class="fa fa-clock-o"></i> <span><?php echo "Internal Mark" ?></span> <i
                                class="fa fa-angle-left pull-right"></i>
                        </a>
