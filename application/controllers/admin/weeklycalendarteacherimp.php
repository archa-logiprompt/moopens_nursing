...
class Weeklycalendarteacher extends Admin_Controller
{
            ...
            if ($this->input->post('search') == 'Search') {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    $data['students'] =
                        ...
                        ->order_by('CAST(roll_no AS UNSIGNED)', 'ASC')
                        ->get()->result_array();
    ...
    function getattendance()
    {
        ...
        // $result = $this->db->where($wherearray)->get('student_period_attendance')->order_by('CAST(roll_no AS UNSIGNED)', 'ASC')->result();



        $result = $this->db->select()->join('students', 'student_period_attendance.student_id=students.id')->join('student_session', 'student_session.student_id=students.id')->where($wherearray)->order_by('CAST(roll_no AS UNSIGNED)', 'ASC')->get('student_period_attendance')->result_array();

        // $result =
        //     $this->db->from('student_session')
        //     ->join('students', 'student_session.student_id=students.id')
        //     ->join('student_period_attendance', 'student_period_attendance.student_id=students.id')
        //     ->where($wherearray)
        //     ->group_by('roll_no')
        //     ->order_by('CAST(roll_no AS UNSIGNED)', 'ASC')
        //     ->get()->result_array();
