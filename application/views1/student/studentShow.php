   ...
   <?php } ?>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane <?php if($student["section_id"] == $snvalue["section_id"]){ echo "active" ; } ?>" id="section<?php echo $snvalue["section_id"]; ?>">
        ...
        <div class="icon"><img src="<?php if(!empty($stvalue["image"])) { echo base_url().$stvalue["image"]; }else{ echo base_url()."uploads/student_images/no_image.png" ; } ?>" alt="User Image"></div>
    ...
    foreach ($student_doc as $value) {
        ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value['doc']; ?> <?php $redoc=getreturndoc($value['id'],$value['student_id']);if(!empty($redoc)){echo '  (Return date:'.$redoc->return_date.') (Return submit date:'.$redoc->returnsubmitdate.')';} ?> </td>
...
<?php echo $this->customlib->getCSRF(); ?>
                   ...
                   <?php $srdata=get_studreturn_doc($student["id"]); if(!empty($student_doc)){ foreach ($student_doc as $value) { if(!in_array($value['id'],$srdata)){ ?>
