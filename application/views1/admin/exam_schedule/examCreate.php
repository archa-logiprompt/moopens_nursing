                        ...
                        <div class="box-body">
                            ...
                            if (!empty($examSchedule)) {
                                ...
                                <form role="form" id="" class="addschedule-form" method="post" action="<?php echo site_url('admin/examschedule/create') ?>">
                                    ...
                                    <input type="hidden" name="section_id" value="<?php echo $section_id; ?>">                                 <input type="hidden" name="sub_type" value="<?php echo $sub_type ?>" />
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php foreach($teacherlist as $teacher){ ?>
                                                        <option value="<?php echo $teacher['id'] ?>"><?php echo $teacher['name'] ?>
                                                    </option>
                                                  <?php   }  $count++; ?>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="topic_<?php echo $value['id'] ?>" class="form-control" id="topic_<?php echo $value['id'] ?>" value="<?php echo $value['topic'] ?>" placeholder="Enter Topics">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
