                                    ...
                                    if (empty($examSchedule)) {
                                        ...
                                        foreach ($examSchedule as $exam) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                <a href="<?php echo base_url(); ?>admin/examschedule/deleted/<?php echo $exam['id'] ?>/<?php echo $exam['exam_id'] ?>"class="btn btn-primary btn-sm schedule_modal"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                            Delete
                                                        </a>
