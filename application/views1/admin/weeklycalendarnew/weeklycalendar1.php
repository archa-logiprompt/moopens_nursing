        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/weeklycalendarnew/index')?>" method="post"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="week" name="week" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <option value="week 1" <?php if($week_number=='week 1') echo 'selected'; ?>>
                                                First Week</option>
                                            <option value="week 2" <?php if($week_number=='week 2') echo 'selected'; ?>>
                                                Second Week</option>
                                            <option value="week 3" <?php if($week_number=='week 3') echo 'selected'; ?>>
                                                Third Week</option>
                                            <option value="week 4" <?php if($week_number=='week 4') echo 'selected'; ?>>
                                                Fourth Week</option>
                                            <option value="week 5" <?php if($week_number=='week 5') echo 'selected'; ?>>
                                                Fifth Week</option>
                                        </select>
                ...
                <?php  if ($is_search){?>
                <div class="box box-primary">
                    <h3 class="titless pull-left"><i class="fa fa-money"></i> <?php echo 'Weekly Report'; ?>
                                ...
                                <table style="width:100%;" border="1">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <?php foreach($days_in_week as $value){ ?>

                                            <th style="padding: 5px;"><?php echo getdateformat($value)?></th>
