...
<div class="content-wrapper" style="min-height: 946px;">
        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stuattendence/classattendencereportbyday') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
  ...
  //var_dump($student_array);
                                                foreach ($student_array as $student_key => $student_value) {
                                                   ...
                                                   // echo $i;
                                                   //var_dump($monthAttendance[$i][$student_value['student_session_id']]['present']);
