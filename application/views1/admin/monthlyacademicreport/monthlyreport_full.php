                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="box-header print  with-border">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-sm-8">   <img src="<?php echo base_url(); ?>\uploads\header.png"   alt="Header Image" style="width: 100%;">
                                    ...
                                    foreach ($subjects_teachers as $key => $value) {
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td style="padding: 5px;text-align:center"><?php echo getSubjectHoursByClassAndSection($class_id,$section_id,$value['subject_id'])['theory_credits'].' hrs'?></td>
                                ...
                                <div class="row" style="padding-top:12px;display: flex;margin-left:2px">
                                    <div class="col-12">
                                        ...
                                        <h5>Number of Holidays in given month - 1 Day</h5>
                                         ...
                                         <h5 style="font-weight:bold">Details of remediation program / advanced learner program</h5> 
                                         <div class="row">
                                             <ol>
                                        ...
                                        <h5 style="font-weight:bold">Name of the class coordinator : <?php echo $userdata['name'] ?></h5> 
                                    </div>
                                </div>
